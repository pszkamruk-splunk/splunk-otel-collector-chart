...
- `chart`: Remove support of deprecated `splunkRealm`, `splunkAccessToken`, `ingestUrl`, `apiUrl`, `metricsEnabled`, `tracesEnabled`, and `logsEnabled` root-level values.yaml options. ([#1985](https://github.com/signalfx/splunk-otel-collector-chart/pull/1985), [#1987](https://github.com/signalfx/splunk-otel-collector-chart/pull/#1987), [#1988](https://github.com/signalfx/splunk-otel-collector-chart/pull/#1988))
...
- `chart`: Remove support of deprecated `otelAgent`, `otelCollector`, and `otelK8sClusterReceiver` configuration sections ([#1990](https://github.com/signalfx/splunk-otel-collector-chart/pull/#1990))
...
- `operator`: Bump java to v2.18.0 in helm-charts/splunk-otel-collector/values.yaml ([#1935](https://github.com/signalfx/splunk-otel-collector-chart/pull/1935))

### 🧰 Bug fixes 🧰

- `agent`: Remove AKS kubeletstat custom CA configuration change. For more information, see the following link https://github.com/signalfx/splunk-otel-collector-chart/blob/main/docs/advanced-configuration.md#aks-kubeletstats-receiver ([#1954](https://github.com/signalfx/splunk-otel-collector-chart/pull/1954))
...
- `operator`: Bump dotnet to v1.11.0 in helm-charts/splunk-otel-collector/values.yaml ([#1927](https://github.com/signalfx/splunk-otel-collector-chart/pull/1927))
- `operator`: Bump nodejs to v3.3.0 in helm-charts/splunk-otel-collector/values.yaml ([#1926](https://github.com/signalfx/splunk-otel-collector-chart/pull/1926))

### 🧰 Bug fixes 🧰

- `gateway`: Fix typo in deployment-gateway.yaml ([#1939](https://github.com/signalfx/splunk-otel-collector-chart/pull/1939))

## [0.129.0] - 2025-07-15

This Splunk OpenTelemetry Collector for Kubernetes release adopts the [Splunk OpenTelemetry Collector v0.129.0](https://github.com/signalfx/splunk-otel-collector/releases/tag/v0.129.0).

### 🛑 Breaking changes 🛑

- `operator`: Operator instrumentation configuration is now defined under `instrumentation.spec`. This change enables full customization of the instrumentation spec, with all user-provided instrumentation fields merged into the default spec. ([#1873](https://github.com/signalfx/splunk-otel-collector-chart/pull/1873))
...
- `operator`: Bump operator to 0.91.0 in helm-charts/splunk-otel-collector/Chart.yaml ([#1914](https://github.com/signalfx/splunk-otel-collector-chart/pull/1914))

### 🧰 Bug fixes 🧰

- `agent`: Fix Signalfx exporter metadata and add necessary mount for bottlerocket OS ([#1898](https://github.com/signalfx/splunk-otel-collector-chart/pull/1898))
...
- `clusterReceiver`: Remove EKS and EC2 resource detectors for EKS/Fargate distribution as the collectors do not have access to IMDS ([#1891](https://github.com/signalfx/splunk-otel-collector-chart/pull/1891))
...
- `operator`: Migrate the operator to use Helm generated TLS certificates instead of cert-manager by default ([#1648](https://github.com/signalfx/splunk-otel-collector-chart/pull/1648))
  ...
  - If you use `.Values.operator.enabled=true` and `.Values.certmanager.enabled=true`, please review the [upgrade guidelines](https://github.com/signalfx/splunk-otel-collector-chart/blob/main/UPGRADING.md#01190-to-01200).
